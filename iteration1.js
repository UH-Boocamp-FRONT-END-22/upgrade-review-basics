...
for (let item of movies) {
    item.categories.forEach(element => {
        if (!sortedMovies.includes(element)) {
            sortedMovies.push(element);
        };
    });

    //El for...each también se puede declarar de la siguiente manera
...
console.log("Estas son todas las películas ordenadas por categoría", sortedMovies);